...
step3 = "Step 3: Run init.py to initialize the required directories and files if you haven't already." if not os.path.isfile("init.exe") else "Step 3: Run init.exe to initialize the required directories and files if you haven't already"
stuff = [
